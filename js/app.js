(() => {
    ...
    function initSliders() {
        if (document.querySelector(".business-benefits")) new swiper_core_Swiper(".business-benefits__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            speed: 800,
            pagination: {
                el: ".business-benefits__pagination",
                clickable: true
            },
            on: {}
        });
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        form.addEventListener("submit", (async function(e) {
            ...
            if (!isValid) alert(errorMessage); else {
